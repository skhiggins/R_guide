...
- Use `tidyverse` and/or `data.table` for wrangling data. 
  ...
  - An excellent primer on `data.table` is available [here](https://cran.r-project.org/web/packages/data.table/vignettes/datatable-intro.html). Additionally, there is a `data.table` guide designed for users transitioning from Stata to R at [Stata2R](https://stata2r.github.io/data.table/) and a `data.table` to `dplyr` guide [here](https://atrebas.github.io/post/2019-03-03-datatable-dplyr/)
